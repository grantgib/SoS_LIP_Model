...
syms x1 x2 p t s 'real' %h
syms sigma_R sigma_T sigma_V sigma_s sigma_Rp sigma_Tp sigma_Rn sigma_Tn 'real' % qh
x = [x1; x2];
R = 2;  %
T = 0.5; % step time
disp('Symbolics');
...
constr2 = V_N - sigma_V*Vtemp - sigma_s*(1-s^2);
